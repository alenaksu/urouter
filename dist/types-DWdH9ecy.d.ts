 ...
 * ```
 */
type NavigationMiddleware = (context: NavigationContext, next: () => Promise<void>) => MaybePromise<void>;
/**
 ...
 * ```
 */
declare class NavigationAbortedError extends Error {
    readonly from: ResolvedRoute | null;
    readonly to: HistoryLocation;
    readonly reason: AbortReason;
    constructor(from: ResolvedRoute | null, to: HistoryLocation, reason: AbortReason);
}
/**
...
export { type AbortReason as A, type GuardResult as G, type HistoryLocation as H, type MaybePromise as M, NavigationAbortedError as N, type RouterOptions as R, type Router as a, type RouterHistory as b, type NavigationContext as c, type NavigationGuard as d, type NavigationMiddleware as e, type ResolvedRoute as f, type RouteDefinition as g, type RouteMeta as h };
